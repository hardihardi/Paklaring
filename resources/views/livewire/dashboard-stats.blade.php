...
<div class="space-y-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Stat Card 1 -->
        <div class="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Total Karyawan</span>
            </div>
            <p class="text-4xl font-black text-slate-800">{{ $totalEmployees }}</p>
        ...
        <div class="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-6">
                <div class="p-4 rounded-2xl bg-green-50 text-green-600 group-hover:bg-green-600 group-hover:text-white transition-colors duration-300">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Paklaring</span>
            </div>
            <p class="text-4xl font-black text-slate-800">{{ $totalCertificates }}</p>
            <div class="mt-4 flex items-center gap-2">
                <div class="h-1.5 flex-1 bg-slate-100 rounded-full overflow-hidden">
                    <div class="h-full bg-green-500 rounded-full w-1/2"></div>
                </div>
                <span class="text-[10px] font-bold text-slate-400">TERBIT</span>
            </div>
        </div>

        <!-- Stat Card 3 -->
        <div class="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300 transform hover:-translate-y-1 md:col-span-2 lg:col-span-1">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Aktivitas</span>
            </div>
            <p class="text-4xl font-black text-slate-800">{{ $recentLogs->count() }}</p>
            <div class="mt-4 flex items-center gap-2">
                <div class="h-1.5 flex-1 bg-slate-100 rounded-full overflow-hidden">
                    <div class="h-full bg-purple-500 rounded-full w-full animate-pulse"></div>
                </div>
